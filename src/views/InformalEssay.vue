                        ...
                        <div class="recommend box__shadow">
                            ...
                            <div class="recommend__content">
                                <div class="recommend__content__box">
                                    ...
                                    <div class="recommend__content__text">
                                    </div>
                                </div>
                            </div>
                            <h2>【紫韵数据】我的奋斗</h2>
                        ...
                        <div class="content__container">
                            ...
                            <section v-for="module in dataContent" :id="module.id" :key="module.id">
                                ...
                                <div class="right__content_aera">
                                    <div class="specific__content box__shadow" v-for="(item, index) in module.content"
                                        :key="index">
                                        <figure class="image c4-izmir c4-image-pan-down"
        ...
        .content {
            ...
            .content__box {
                ...
                .left {
                    ...
                    .personCard {
                        background-image: linear-gradient(135deg, #a9e0ec 15%, #c0bdf0 100%);
                        border-radius: 10px;
                        padding: 1rem 0;
                        transition: all 0.3s;
                    ...
                    .anchorPointNav {
                        ...
                        .anchorPointList {
                            li {
                                ...
                                background-image: linear-gradient(100deg, #348cff 15%, #17c3ff 100%);
                                ...
                                &:nth-child(2) {
                                    background-image: linear-gradient(100deg, #18e7af 15%, #1eebe9 100%);
                                }

                                &:nth-child(3) {
                                    background-image: linear-gradient(100deg, #ff6954 15%, #ffbc38 100%);
                                }

                                &:nth-child(4) {
                                    background-image: linear-gradient(100deg, #ff2cda 15%, #ff7816 100%);
                                }
                            }
                        }
