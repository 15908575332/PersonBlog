        ...
        <div class="content__container">
            ...
            <div class="profile__picture">
                <ul>
                    ...
                    <li class="item heart">
                        <img src="@/assets/img/family/heart.png" alt="heart">
                    </li>
                    <li class="item">
            ...
            <div class="content__col">
                ...
                <div class="title__time">
                    ...
                    <p>春节倒计时： {{ countdown.days }}天{{ countdown.hours }}时{{ countdown.minutes }}分{{ countdown.seconds
                    }}秒
                    </p>
                </div>
                <!-- 飞车传信 -->
                            ...
                            <div class="content-perspective">
                                <div class="content">
                                    <div class="content-inner">
                                        ...
                                        <p>Don't be too proud of this technological terror you've constructed. The
                                            ability tothe presence of my old master. Escape is not his plan. I must face
                                            him.Alone.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-perspective">
                                <div class="content">
                                    <div class="content-inner">
                                        ...
                                        <p>Ha, illiandran. And youwill not call me 'you'. You will never address me as
                                            'you'. You will call me
                                            'your royalhighness'. I really must go back. I shouldn't have run away. I
                                            realize nowthat love is
                                            one lucannot afford. </p>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="content-perspective">
                                <div class="content">
                                    <div class="content-inner">
                                        ...
                                        <p>You make it so difficult sometimes. You have your moments. Not many of them
                                            Evacuate staff.
                                        </p>
                                    </div>
                                </div>
                ...
                <div v-else="changeModule === 'module3'">
                    <div class="g-container">
                        <div class="g-item" data-aos="fade-up">
...
// 春节倒计时
const springFestivalDate = new Date(2026, 1, 17); // 注意：月份从0开始，1代表2月
const countdown = ref({
    days: 0,
    hours: 0,
    minutes: 0,
...
#family {
    ...
    .content__container {
        ...
        // 内容
        .content__col {
            //  background: linear-gradient(rgba(244, 0, 0, 0.1) 2%, rgb(255, 255, 255, .8) 0);
            ...
            .main {
                ...
                .user-2 {
                    background-image: url(@/assets/img/profile_picture/10056.png);
                    background-size: 100% 100%;
                }

                .user-3 {
                    background-image: url(@/assets/img/profile_picture/10058.png);
                    background-size: 100% 100%;
                }

                .user-4 {
                    background-image: url(@/assets/img/profile_picture/10059.png);
                    background-size: 100% 100%;
                }
                ...
                .event input[type="radio"]:checked~.thumb {
                    ...
                    box-shadow: 0 0 0 2px rgba(242, 99, 40, 1), 0 1px 1px rgba(255, 255, 255, 0.5);
                }
