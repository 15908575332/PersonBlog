<template>
    <div style="width: 100%;">
        <div class="navigate" :class="{ 'hoverStyle': isHover }">
            ...
            <!-- 导航控制 -->
            <div @click="toggleSidebar" class="button phone-none"><img src="@/assets/icon/phone/phone-navigateMenu.svg"
                    alt="navi">
            </div>
                    ...
                    <ul class="nav-btn" ref="navBtn" :class="{ 'visible': isSidebarVisible }">
                        ...
                        <li v-if="LoginStatus" class="loginSuccess">
                            ...
                            <div v-if="isVisible" class="modal-overlay" @click.self="closeModal"
                                :class="{ 'infoClose': isVisible, 'modal-overlay': true }">
                                <div class="modal-content" @click.stop>
                                    <button @click="closeModal"><img src="./icon/close.svg" alt="close"></button>
                                    <div class="info">
                                        <span>测试hxc</span>
...
const record_options = ref([
    { value: 'option1', text: '内容', router: 'recordList/content', engTitle: 'content' },
    { value: 'option2', text: '专栏', router: 'recordList/column', engTitle: 'column' },
    { value: 'option1', text: '资源', router: 'recordList/resource', engTitle: 'resource' },
    { value: 'option2', text: '学习人生', router: 'recordList/learning', engTitle: 'learning' },
    { value: 'option3', text: '寻国记', router: 'recordList/country', engTitle: 'country' },
]);
const treasureBox_options = ref([
    { value: 'option1', text: '音乐', router: 'treasureBox/music', iconUrl: utils.getAssetsFile('icon/music_navigate_icon.svg') },
    {
        value: 'option2', text: '收藏夹', router: 'treasureBox/favorites', iconUrl: utils.getAssetsFile('icon/favorites_navigate_icon.svg')
    },
    { value: 'option3', text: '友链', router: 'treasureBox/friendshipLink', iconUrl: utils.getAssetsFile('icon/helpLink_navigate_icon.svg') },
]);
const showModalFun = () => {
...
.navigate {
    ...
    &:hover {
        background-color: rgb(25, 29, 15, .6);
        transition: all 0.3s linear;
    }
        ...
        .loginSuccess {
            ...
            .modal-overlay {
                ...
                .modal-content {
                    ...
                    animation: fadeOutBottomRight 0.8s cubic-bezier(0.215, 0.610, 0.355, 1.000) forwards;
